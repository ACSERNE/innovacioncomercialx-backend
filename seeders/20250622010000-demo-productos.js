...
module.exports = {
  async up(queryInterface) {
    ...
    // 👤 Obtener usuario demo como autor
    const usuarios = await queryInterface.sequelize.query(
      `SELECT id FROM users WHERE correo = 'user@example.com'`,
      { type: queryInterface.sequelize.QueryTypes.SELECT }
    );
    ...
    // 📦 Productos con IDs fijos para referencia en transacciones
    const productos = [
      {
        id: '7285a0a3-555e-49c1-965f-f22043221406',  // ID fijo
      ...
      {
        id: 'd7f92e2f-1b58-4e7f-bf8c-123456789abc',  // ID fijo
      ...
      {
        id: 'a3f1c2b4-5d6e-789f-0123-456789abcdef',  // ID fijo
